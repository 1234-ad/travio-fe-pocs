...
export default function LoginForm() {
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <h1 className="text-4xl font-bold text-gray-800 mb-8 text-center">Log in</h1>
      ...
      <div className="mt-6 text-center">
        <Link href="/forgot-password" className="text-gray-600 hover:text-gray-800 transition-colors">
